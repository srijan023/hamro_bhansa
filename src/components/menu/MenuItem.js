...
export default function MenuItem() {
  return (
    <div className="hover:scale-105 hover:transition-all transition-all hover:bg-gray-100 p-2 rounded-xl">
      ...
      <div className="text-center flex flex-col gap-2 mt-3 ">
        <h3 className="font-semibold text-xl text-gray-600">Plain Dhal Bhat Set</h3>
