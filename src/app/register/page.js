    ...
    <section className="flex w-full mt-4 gap-6">
      <div className="relative w-1/2">
        ...
        <div className="text-center text-gray-100 absolute h-full flex justify-center flex-col gap-4 items-center w-full">
          ...
          <p className="text-sm">
            One stop destination for authentic Nepali cuisine!
          </p>
        </div>
      </div>
      <div className="my-6 flex flex-col items-center ">
        ...
        {(userCreated || error) && (
          <div
            className={`my-4  ${!error ? "bg-green-300" : "bg-red-200"} text-center py-3 px-5 text-gray-700 rounded-xl`}
          >
            {message}
          </div>
        )}
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <FormElement
              ...
              value={confPassword}
              onChange={(ev) => setLastPass(ev.target.value)}
            />
          </div>
          ...
          <div className="flex text-gray-500 justify-center">
            <p className=" w-2/3 text-wrap text-center">
              By clicking on the above buttons you agree on the terms and
